                ...
                <div class="table table-responsive">
                    <div class="table-header">
                        <div class="row">
                            ...
                            <div class="text-center col-1">Editar</div>
                            <div class="text-center col-1">Historial</div>
                        </div>
                    </div>
                    <div 
                        ...
                        class="table-row">
                        <div class="row">
                            <div class="col-lg-2"><label>DNI:</label>{{ item.dni }}</div>
                            <div class="col-lg-3"><label>Descripción</label>{{ item.nombres + ' ' + item.ape_paterno+ ' ' + item.ape_materno }}</div>
                            <div class="col-lg-2"><label>Teléfono:</label>{{ item.telefono }}</div>
                            <div class="col-lg-3"><label>Email</label>{{ item.email}}</div>
                            <div class="text-center col-6 col-lg-1">
